...
const SliderSticky = () => {
	...
	let icon4 = document.getElementById("benefits__icon4");
					...
					<div className="m4__container sticky">
						<div className="m4__left-wrapper" ref={leftWrapper}>
							...
							<motion.div
								...
								style={{
									backgroundImage: `url(${images.sleepBg})`,
								}}
								initial={{ opacity: 0 }}
								animate={{ opacity: 1 }}
								exit={{ opacity: 0 }}
